...
var q1 = prompt('My hair color is black ? (yes or no)').toLocaleLowerCase();
var q2 = prompt('am i a pet lover ? (yes or no)').toLocaleLowerCase();
var q3 = prompt('i don\'t ware glasses ? (yes or no)').toLocaleLowerCase();
var q4 = prompt('am i longer than 178 ? (yes or no)').toLocaleLowerCase();
var q5 = prompt('my favourite color is blue ? (yes or no)').toLocaleLowerCase();
var result = 0;
